"""
Cookiecutter PyProject Development Watcher
...
Usage:
    1. Run this script from the cookiecutter-pyproject-2025 repo root directory
...
class ChangeHandler(FileSystemEventHandler):
    ...
    def on_any_event(self, event):
        ...
        if current_time - self.last_run > self.debounce_period:
            ...
            try:
                # The output directory is in the repo root (matches cookiecutter.json project_slug)
